...
//    private var posters: List<PosterData> = emptyList()
//    var posters: List<PosterData> = emptyList()
    var posters: ArrayList<PosterData>
...
//            v?.onTouchEvent(event) ?: true
    ...
    fun setSpots(posters: ArrayList<PosterData>) {
        this.posters = posters
    }

    fun getSpots(): ArrayList<PosterData> {
        return posters
    }
